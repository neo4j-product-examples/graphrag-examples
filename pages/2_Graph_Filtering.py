...
from graph_rag import GraphRAGChain, GraphRAGPreFilterChain
...
ORDER BY recommendationScore DESC LIMIT 500
        ...
        with st.spinner('Running GraphRAG...'):
            with st.expander('__Response:__', True):
                st.markdown(graphrag_prefilter_chain.invoke(
                    ...
                    retrieval_search_text=customer_interests, query_params={"customerId": customer_id})
                )
